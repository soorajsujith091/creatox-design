...
export function GrandMalabarExpo() {
  ...
  return (
    <section className="py-24 bg-white px-6 overflow-hidden" aria-label="Grand Malabar Expo Feature">
      <div className="max-w-[1400px] mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24" ref={containerRef}>
        ...
        <div className="lg:w-[55%] flex flex-col justify-center">
          ...
          <h2 className="font-heading text-[48px] text-[#0A0A0A] font-semibold leading-tight mb-2">
          ...
          <div className="flex flex-col gap-8 mb-12">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 shrink-0 rounded-full bg-[#F7F7F7] border border-[#E8E8E8] flex items-center justify-center text-red mt-1">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z" />
                </svg>
              </div>
              <div>
                <h3 className="font-heading text-[20px] text-[#0A0A0A] font-bold mb-2">High Walk-Ins</h3>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-heading text-[20px] text-[#0A0A0A] font-bold mb-2">Powerful Business Connections</h3>
                <p className="font-body text-[15px] text-[#666666] leading-relaxed">
          ...
          <div className="flex gap-12 mb-12 pb-12 border-b border-[#E8E8E8]">
            <div>
          ...
          <Link
            ...
            className="inline-block border border-[#0A0A0A] text-[#0A0A0A] px-8 py-4 text-[14px] font-body hover:bg-red hover:text-white hover:border-red transition-all duration-300 w-fit"
          >
            More Details →
          </Link>
        </div>
        ...
        {/* Right Image */}
        <div className="lg:w-[45%] h-[500px] lg:h-auto relative rounded-[4px] overflow-hidden border border-[#E8E8E8] shadow-[0_8px_40px_rgba(0,0,0,0.08)]">
          <Image
